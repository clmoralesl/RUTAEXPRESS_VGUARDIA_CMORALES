...
Este repositorio actúa como el **Hub Central de Gestión y Documentación** del sistema **RutaExpress** para la Evaluación Parcial 1 (Sprint 1) y Evaluación Parcial 2 (Sprint 2).

Aquí se centralizan los **28 Issues del proyecto**, la documentación técnica, las pautas de evaluación y el seguimiento del trabajo mediante **GitHub Projects**.
...
| :--- | :--- | :--- |
| **BFF (Backend For Frontend)** | 🛡️ [ms-rutaexpress-bff](https://github.com/clmoralesl/ms-rutaexpress-bff) | Resource Server OAuth2 / RBAC en Spring Boot 3 |
...
- **`DOCS/backlog.md`**: Backlog maestro completo con los 28 Issues del proyecto.
- **`DOCS/responsabilidades.md`**: Matriz de asignación de tareas (60% Claudio / 40% Valeska).
- **`.agents/`**: Configuración de reglas y agentes para desarrollo asistido.
